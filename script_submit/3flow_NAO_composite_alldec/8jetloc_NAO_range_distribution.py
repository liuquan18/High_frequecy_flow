...
# save the results
save_dir = "/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6_allplev/0composite_alldec/"

theta_2PVU_poss.to_netcdf(f'{save_dir}jetloc{suffix}_NAO_pos_{decade}.nc')
theta_2PVU_negs.to_netcdf(f'{save_dir}jetloc{suffix}_NAO_neg_{decade}.nc')
