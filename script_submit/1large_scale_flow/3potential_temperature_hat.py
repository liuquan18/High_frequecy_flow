...
to_path = f'/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6_allplev/theta_hat_daily/r{member}i1p1f1/'
...
for i, dec in enumerate (dec_core):
    ...
    theta = EP_flux.potential_temperature(t, p='plev', p0=1e5)    # save to netcdf
