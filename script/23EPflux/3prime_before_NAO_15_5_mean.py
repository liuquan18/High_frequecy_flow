...
def process_data(decade, var, integrate=False, **kwargs):
    ...
    ivke_NAO_pos = before_NAO_composite(NAO_pos, data, time_window)
    ivke_NAO_neg = before_NAO_composite(NAO_neg, data, time_window)
...
if __name__ == "__main__":
    ...
    process_data(
        decade, var, integrate, name=name, plev=None, window=window, suffix=suffix
    )
