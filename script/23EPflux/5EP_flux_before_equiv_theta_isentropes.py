...
#%%
etheta_pos_first = read_composite_MPI('equiv_theta', 'etheta', 1850, '15_5', 'pos',  ano=False)
etheta_pos_last = read_composite_MPI('equiv_theta', 'etheta', 2090, '15_5', 'pos',  ano=False)
etheta_neg_first = read_composite_MPI('equiv_theta', 'etheta', 1850, '15_5', 'neg',  ano=False)
etheta_neg_last = read_composite_MPI('equiv_theta', 'etheta', 2090, '15_5', 'neg',  ano=False)
#%%
etheta_pos_first['plev'] = etheta_pos_first['plev'] / 100
etheta_pos_last['plev'] = etheta_pos_last['plev'] / 100
etheta_neg_first['plev'] = etheta_neg_first['plev'] / 100
etheta_neg_last['plev'] = etheta_neg_last['plev'] / 100
# %%
# convert to isentropes
F_phi_pos_first = plev_to_isentrope(F_phi_pos_first, etheta_pos_first, var_name = 'F_phi', theta_name = 'etheta')
F_p_pos_first = plev_to_isentrope(F_p_pos_first, etheta_pos_first, var_name = 'F_p', theta_name = 'etheta')
F_phi_neg_first = plev_to_isentrope(F_phi_neg_first, etheta_neg_first, var_name = 'F_phi', theta_name = 'etheta')
F_p_neg_first = plev_to_isentrope(F_p_neg_first, etheta_neg_first, var_name = 'F_p', theta_name = 'etheta')

F_phi_pos_last = plev_to_isentrope(F_phi_pos_last, etheta_pos_last, var_name = 'F_phi', theta_name = 'etheta')
F_p_pos_last = plev_to_isentrope(F_p_pos_last, etheta_pos_last, var_name = 'F_p', theta_name = 'etheta')
F_phi_neg_last = plev_to_isentrope(F_phi_neg_last, etheta_neg_last, var_name = 'F_phi', theta_name = 'etheta')
F_p_neg_last = plev_to_isentrope(F_p_neg_last, etheta_neg_last, var_name = 'F_p', theta_name = 'etheta')

div_pos_first = plev_to_isentrope(div_pos_first, etheta_pos_first, var_name = 'div', theta_name = 'etheta')
div_neg_first = plev_to_isentrope(div_neg_first, etheta_neg_first, var_name = 'div', theta_name = 'etheta')
div_pos_last = plev_to_isentrope(div_pos_last, etheta_pos_last, var_name = 'div', theta_name = 'etheta')
div_neg_last = plev_to_isentrope(div_neg_last, etheta_neg_last, var_name = 'div', theta_name = 'etheta')
#%%
# save all the above isentrope data
save_dir = "/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/0EP_flux_isen/"
F_phi_pos_first.to_netcdf(save_dir + "F_phi_pos_first.nc")
F_p_pos_first.to_netcdf(save_dir + "F_p_pos_first.nc")
F_phi_neg_first.to_netcdf(save_dir + "F_phi_neg_first.nc")
F_p_neg_first.to_netcdf(save_dir + "F_p_neg_first.nc")  
F_phi_pos_last.to_netcdf(save_dir + "F_phi_pos_last.nc")
F_p_pos_last.to_netcdf(save_dir + "F_p_pos_last.nc")
F_phi_neg_last.to_netcdf(save_dir + "F_phi_neg_last.nc")
F_p_neg_last.to_netcdf(save_dir + "F_p_neg_last.nc")
div_pos_first.to_netcdf(save_dir + "div_pos_first.nc")
div_neg_first.to_netcdf(save_dir + "div_neg_first.nc")
div_pos_last.to_netcdf(save_dir + "div_pos_last.nc")
div_neg_last.to_netcdf(save_dir + "div_neg_last.nc")
