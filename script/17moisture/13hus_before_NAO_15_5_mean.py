...
def read_all_data(decade, var, **kwargs):
    ...
    hf_data = read_prime(
        decade, var=var, suffix="_std", **kwargs
...
def process_data(decade, var):
    ...
    hus_NAO_pos = before_NAO_composite(NAO_pos, data)
    hus_NAO_neg = before_NAO_composite(NAO_neg, data)
    ...
    hus_NAO_neg.to_netcdf(save_dir_neg)
