...
#%%
first_ratio = first_data.hus / first_data.tas
first_ratio = first_ratio.mean(dim = ('time', 'ens'))
# %%
last_ratio = last_data.hus / last_data.tas
last_ratio = last_ratio.mean(dim = ('time', 'ens'))
# %%
first_ratio.to_netcdf("/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/tas_moisture_variability/first_ratio.nc")
# %%
last_ratio.to_netcdf("/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/tas_moisture_variability/last_ratio.nc")
# %%
