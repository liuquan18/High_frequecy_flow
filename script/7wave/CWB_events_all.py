...
plt.savefig('/work/mh0033/m300883/High_frequecy_flow/docs/plots/wave_break/CWB_all.png')
# %%
first10_pos_CWBs.to_csv("/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/WB_before_NAO/CWB_all_first10.csv", index=False)
last10_pos_CWBs.to_csv("/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/WB_before_NAO/CWB_all_last10.csv", index=False)
# %%
