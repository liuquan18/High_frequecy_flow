...
def read_MPI_GE_uhat():
    ...
    uhat_pos_first10 = postprocess(uhat_pos_first10)
    uhat_neg_first10 = postprocess(uhat_neg_first10)
    uhat_pos_last10 = postprocess(uhat_pos_last10)
    uhat_neg_last10 = postprocess(uhat_neg_last10)

    return (uhat_pos_first10, uhat_neg_first10), (uhat_pos_last10, uhat_neg_last10)
#%%
...
#%%
upvp_ERA5 = [smooth(upvp, lat_window=40, lon_window=80) for upvp in upvp_ERA5] # smooth the data
# %%
...
# %% change units
ivke_ERA5 = [ivke * 1e6 for ivke in ivke_ERA5]
ivke_first = [ivke * 1e6 for ivke in ivke_first]
