...
break_type = 'CWB'
# %%
def read_WB_events(period="first10", break_type="CWB"):
...
# %%
first10_WBs = read_WB_events("first10", 'CWB')
# %%
last10_WBs = read_WB_events("last10", 'CWB')
# %%
fig, ax = plt.subplots(
...
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/wave_break/Scherrer_CWB_climatology_track.png"
)
# %%
...
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/wave_break/Scherrer_CWB_climatology_duration.png"
)
...
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/wave_break/Scherrer_CWB_climatology_delta_lon.png"
)
...
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/wave_break/Scherrer_CWB_climatology_delta_lat.png"
)
...
# %%
first_NAO = first10_neg # CWB corresponds to NAO negative
last_NAO = last10_neg
#%%
first_pacific_CWB_before_NAO, first_pacific_CWB_during_NAO = WB_NAO_concurrence(first_NAO, first10_WBs_pacific)

#%%
last_pacific_CWB_before_NAO, last_pacific_CWB_during_NAO = WB_NAO_concurrence(last_NAO, last10_WBs_pacific)
#%%
first_atlantic_CWB_before_NAO, first_atlantic_CWB_during_NAO = WB_NAO_concurrence(first_NAO, first10_WBs_atlantic)

#%%
last_atlantic_CWB_before_NAO, last_atlantic_CWB_during_NAO = WB_NAO_concurrence(last_NAO, last10_WBs_atlantic)
# %%
# duration for before pacific
first_pacific_CWB_before_NAO_dur = wb_duration(first_pacific_CWB_before_NAO)
last_pacific_CWB_before_NAO_dur = wb_duration(last_pacific_CWB_before_NAO)

# duration for during pacific
first_pacific_CWB_during_NAO_dur = wb_duration(first_pacific_CWB_during_NAO)
last_pacific_CWB_during_NAO_dur = wb_duration(last_pacific_CWB_during_NAO)

# duration for before atlantic
first_atlantic_CWB_before_NAO_dur = wb_duration(first_atlantic_CWB_before_NAO)
last_atlantic_CWB_before_NAO_dur = wb_duration(last_atlantic_CWB_before_NAO)

# duration for during atlantic
first_atlantic_CWB_during_NAO_dur = wb_duration(first_atlantic_CWB_during_NAO)
last_atlantic_CWB_during_NAO_dur = wb_duration(last_atlantic_CWB_during_NAO)
# %%
fig, ax = plt.subplots(2, 2, figsize=(10, 10))
bins = np.arange(5, 40, 2)

# before NAO
sns.histplot(first_pacific_CWB_before_NAO_dur, ax=ax[0, 0], bins=bins, kde=False)
sns.histplot(last_pacific_CWB_before_NAO_dur, ax=ax[0, 0], bins=bins, kde=False, alpha=0.5)

# add legend
ax[0, 0].legend(["First 10 years", "Last 10 years"])
ax[0, 0].set_title("Pacific WBs before NAO+")

sns.histplot(first_atlantic_CWB_before_NAO_dur, ax=ax[0, 1], bins=bins, kde=False)
sns.histplot(last_atlantic_CWB_before_NAO_dur, ax=ax[0, 1], bins=bins, kde=False, alpha=0.5)
ax[0, 1].set_title("Atlantic WBs before NAO+")

# during NAO
sns.histplot(first_pacific_CWB_during_NAO_dur, ax=ax[1, 0], bins=bins, kde=False)
sns.histplot(last_pacific_CWB_during_NAO_dur, ax=ax[1, 0], bins=bins, kde=False, alpha=0.5)

sns.histplot(first_atlantic_CWB_during_NAO_dur, ax=ax[1, 1], bins=bins, kde=False)
sns.histplot(last_atlantic_CWB_during_NAO_dur, ax=ax[1, 1], bins=bins, kde=False, alpha=0.5)
...
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/wave_break/Scherrer_CWB_climatology_beforeduring_NAO+_duration.png"
)
# %%
# elongation for before pacific
first_pacific_CWB_before_NAO_elong = delta_lon(first_pacific_CWB_before_NAO)
last_pacific_CWB_before_NAO_elong = delta_lon(last_pacific_CWB_before_NAO)

# elongation for during pacific
first_pacific_CWB_during_NAO_elong = delta_lon(first_pacific_CWB_during_NAO)
last_pacific_CWB_during_NAO_elong = delta_lon(last_pacific_CWB_during_NAO)

# elongation for before atlantic
first_atlantic_CWB_before_NAO_elong = delta_lon(first_atlantic_CWB_before_NAO)
last_atlantic_CWB_before_NAO_elong = delta_lon(last_atlantic_CWB_before_NAO)

# elongation for during atlantic
first_atlantic_CWB_during_NAO_elong = delta_lon(first_atlantic_CWB_during_NAO)
last_atlantic_CWB_during_NAO_elong = delta_lon(last_atlantic_CWB_during_NAO)
# %%
fig, ax = plt.subplots(2, 2, figsize=(10, 10))
bins = np.arange(0, 51, 2)

# before NAO
sns.histplot(first_pacific_CWB_before_NAO_elong, ax=ax[0, 0], bins=bins, kde=False)
sns.histplot(last_pacific_CWB_before_NAO_elong, ax=ax[0, 0], bins=bins, kde=False, alpha=0.5)


sns.histplot(first_atlantic_CWB_before_NAO_elong, ax=ax[0, 1], bins=bins, kde=False)
sns.histplot(last_atlantic_CWB_before_NAO_elong, ax=ax[0, 1], bins=bins, kde=False, alpha=0.5)
...
# during NAO
sns.histplot(first_pacific_CWB_during_NAO_elong, ax=ax[1, 0], bins=bins, kde=False)
sns.histplot(last_pacific_CWB_during_NAO_elong, ax=ax[1, 0], bins=bins, kde=False, alpha=0.5)

sns.histplot(first_atlantic_CWB_during_NAO_elong, ax=ax[1, 1], bins=bins, kde=False)
sns.histplot(last_atlantic_CWB_during_NAO_elong, ax=ax[1, 1], bins=bins, kde=False, alpha=0.5)
...
# delta latitude
# elongation for before pacific
first_pacific_CWB_before_NAO_lat = delta_lat(first_pacific_CWB_before_NAO)
last_pacific_CWB_before_NAO_lat = delta_lat(last_pacific_CWB_before_NAO)

# elongation for during pacific
first_pacific_CWB_during_NAO_lat = delta_lat(first_pacific_CWB_during_NAO)
last_pacific_CWB_during_NAO_lat = delta_lat(last_pacific_CWB_during_NAO)

# elongation for before atlantic
first_atlantic_CWB_before_NAO_lat = delta_lat(first_atlantic_CWB_before_NAO)
last_atlantic_CWB_before_NAO_lat = delta_lat(last_atlantic_CWB_before_NAO)

# elongation for during atlantic
first_atlantic_CWB_during_NAO_lat = delta_lat(first_atlantic_CWB_during_NAO)
last_atlantic_CWB_during_NAO_lat = delta_lat(last_atlantic_CWB_during_NAO)
# %%
fig, ax = plt.subplots(2, 2, figsize=(10, 10))
bins = np.arange(0, 30, 2)

# before NAO
sns.histplot(first_pacific_CWB_before_NAO_lat, ax=ax[0, 0], bins=bins, kde=False)
sns.histplot(last_pacific_CWB_before_NAO_lat, ax=ax[0, 0], bins=bins, kde=False, alpha=0.5)

sns.histplot(first_atlantic_CWB_before_NAO_lat, ax=ax[0, 1], bins=bins, kde=False)
sns.histplot(last_atlantic_CWB_before_NAO_lat, ax=ax[0, 1], bins=bins, kde=False, alpha=0.5)
...
# during NAO
sns.histplot(first_pacific_CWB_during_NAO_lat, ax=ax[1, 0], bins=bins, kde=False)
sns.histplot(last_pacific_CWB_during_NAO_lat, ax=ax[1, 0], bins=bins, kde=False, alpha=0.5)


sns.histplot(first_atlantic_CWB_during_NAO_lat, ax=ax[1, 1], bins=bins, kde=False)
sns.histplot(last_atlantic_CWB_during_NAO_lat, ax=ax[1, 1], bins=bins, kde=False, alpha=0.5)
