...
to_path=/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/${var}_daily_global/${var}_MJJAS_ano_${period}_prime_intermedia/
...
band_filter(){
    ...
    # band filter, keep 5-12 days 
    year_files=$(ls ${tmp_dir}${fname}_year*)
    cdo -O -P 10 -mergetime -apply,bandpass,30.5,73 [ ${year_files} ] ${outfile}
