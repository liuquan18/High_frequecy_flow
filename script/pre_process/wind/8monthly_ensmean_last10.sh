...
cdo -selmon,5/9 -ensmean $file_list1 ${to_path}"${var}_Amon_MPI-ESM1-2-LR_HIST_ensmean_207505-209409.nc"
cdo -selmon,5/9 -ensmean $file_list2 ${to_path}"${var}_Amon_MPI-ESM1-2-LR_HIST_ensmean_209505-210009.nc"