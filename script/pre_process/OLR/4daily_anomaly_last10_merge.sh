...
merge(){
    member=$1
    infile1=/scratch/m/m300883/OLR/list1/rlut_day_MPI-ESM1-2-LR_ssp585_r${member}i1p1f1_gn_20750101-20941231_ano.nc
    infile2=/scratch/m/m300883/OLR/list2/rlut_day_MPI-ESM1-2-LR_ssp585_r${member}i1p1f1_gn_20950101-21001231_ano.nc
