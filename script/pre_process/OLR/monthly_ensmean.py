...
os.system(
    f"cdo -selmon,5/9 -ensmean {last10_month_files1.path.str.cat(sep=' ')} {data_cache_path}OLR_monthly_ensmean_207505-209409.nc"
)

# ensemean for the last10_month_files2
os.system(
    f"cdo -selmon,5/9 -ensmean {last10_month_files2.path.str.cat(sep=' ')} {data_cache_path}OLR_monthly_ensmean_209505-210009.nc"
)
#%%
