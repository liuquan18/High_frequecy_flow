...
daily_zg_path=f"/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/daily/zg_NA_daily_ano/r{member}i1p1f1/"
...
pc_path=f"/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/NAO_pc_decade_nonstd/r{member}i1p1f1/"
...
for i, start_year in enumerate(start_years_single):
    ...
    projected_pcs = project_field_to_pattern(daily_field, eof, standard=False, plev = 25000)
