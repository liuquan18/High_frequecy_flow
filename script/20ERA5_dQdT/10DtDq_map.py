...
# %%
tas_mean = xr.open_dataset("/work/mh0033/m300883/High_frequecy_flow/data/ERA5/moisture_variability_stat/tas_daily_std_mergeyear_timmean.nc")
...
fig, axes = plt.subplots(
    1, 2, figsize=(12, 6), subplot_kw={"projection": ccrs.PlateCarree(-90)}
)

tas_mean.plot(ax=axes[0], transform=ccrs.PlateCarree(), cmap=temp_cmap_seq, levels=temp_levels)
