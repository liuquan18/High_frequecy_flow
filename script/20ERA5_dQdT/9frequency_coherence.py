...
# true if split the var1 into NAL and NPO
...
if var1 == 'vt':
    ...
    var1_path = '/work/mh0033/m300883/High_frequecy_flow/data/ERA5/hus_daily_std_mergeyear/'

elif var1 == 'tas':
    var1_path = '/work/mh0033/m300883/High_frequecy_flow/data/ERA5/tas_daily_std_mergeyear/'

if var2 == 'va':
    var2_path = '/work/mh0033/m300883/High_frequecy_flow/data/ERA5/va_daily_rm_trend_mergeyear/'
elif var2 == 'vt':
    logging.error('vt is not calculated yet')
...
if pixel_wise:
    ...
    coherence_path = f'/work/mh0033/m300883/High_frequecy_flow/data/ERA5/{var1}_{var2}_coherence/'
...
for i, year in enumerate(years_single):
    ...
    if split_basin:
        ...
        coherence_NAL.to_netcdf(f"{coherence_path}coherence_NAL_{var1}_{var2}_{year}.nc")


        coherence_NPO = coherence_analy(var_da_NPO, pixel_wise = pixel_wise)
        coherence_NPO.to_netcdf(f"{coherence_path}coherence_NPO_{var1}_{var2}_{year}.nc")
