...
for dec in range(1850, 2091, 10):
    df_dec_NPC = construct_df(dec, "NPC")
    dfs_NPC.append(df_dec_NPC)

dfs_NPC = pd.concat(dfs_NPC, axis=0)

# %%
dfs_NAL = dfs_NAL.reset_index()
dfs_NPC = dfs_NPC.reset_index()
# %%
...
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/regression_2_vp/regression_basin_mean.png"
)
# %%
fig, ax = plt.subplots(2, 1, figsize=(10, 10))
sns.scatterplot(
...
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/regression_2_vp/regression_basin_mean_tas.png"
)
# %%
