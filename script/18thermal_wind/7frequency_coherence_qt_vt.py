...
hus_vt_Cxy_NPC = read_Cxy("hus_std", "vt", "NPC")
# %%
tas_vt_Cxy_NAL = read_Cxy("tas_std", "vt", "NAL")
tas_vt_Cxy_NPC = read_Cxy("tas_std", "vt", "NPC")
# %%
vt_va_Cxy_NAL = read_Cxy("vt", "va", "NAL")
vt_va_Cxy_NPC = read_Cxy("vt", "va", "NPC")
# %%
...
hus_vt_NPC_mean, hus_vt_NPC_95, hus_vt_NPC_05 = get_plot_data(hus_vt_Cxy_NPC)

vt_va_mean, vt_va_95, vt_va_05 = get_plot_data(vt_va_Cxy, globe_mean=False)
# %%
hus_vt_NAL_mean_first, hus_vt_NAL_95_first, hus_vt_NAL_05_first = get_plot_data(
    hus_vt_Cxy_NAL, period="first"
)
hus_vt_NPC_mean_first, hus_vt_NPC_95_first, hus_vt_NPC_05_first = get_plot_data(
    hus_vt_Cxy_NPC, period="first"
)

vt_va_mean_first, vt_va_95_first, vt_va_05_first = get_plot_data(
    vt_va_Cxy, globe_mean=False, period="first"
)
# %%
hus_vt_NAL_mean_last, hus_vt_NAL_95_last, hus_vt_NAL_05_last = get_plot_data(
    hus_vt_Cxy_NAL, period="last"
)
hus_vt_NPC_mean_last, hus_vt_NPC_95_last, hus_vt_NPC_05_last = get_plot_data(
    hus_vt_Cxy_NPC, period="last"
)

vt_va_mean_last, vt_va_95_last, vt_va_05_last = get_plot_data(
    vt_va_Cxy, globe_mean=False, period="last"
)
# %%
tas_vt_NAL_mean, tas_vt_NAL_95, tas_vt_NAL_05 = get_plot_data(tas_vt_Cxy_NAL)
tas_vt_NPC_mean, tas_vt_NPC_95, tas_vt_NPC_05 = get_plot_data(tas_vt_Cxy_NPC)

tas_vt_NAL_mean_first, tas_vt_NAL_95_first, tas_vt_NAL_05_first = get_plot_data(
    tas_vt_Cxy_NAL, period="first"
)
tas_vt_NPC_mean_first, tas_vt_NPC_95_first, tas_vt_NPC_05_first = get_plot_data(
    tas_vt_Cxy_NPC, period="first"
)

tas_vt_NAL_mean_last, tas_vt_NAL_95_last, tas_vt_NAL_05_last = get_plot_data(
    tas_vt_Cxy_NAL, period="last"
)
tas_vt_NPC_mean_last, tas_vt_NPC_95_last, tas_vt_NPC_05_last = get_plot_data(
    tas_vt_Cxy_NPC, period="last"
)

# %%
vt_va_NAL_mean, vt_va_NAL_95, vt_va_NAL_05 = get_plot_data(vt_va_Cxy_NAL)
vt_va_NPC_mean, vt_va_NPC_95, vt_va_NPC_05 = get_plot_data(vt_va_Cxy_NPC)

vt_va_NAL_mean_first, vt_va_NAL_95_first, vt_va_NAL_05_first = get_plot_data(
    vt_va_Cxy_NAL, period="first"
)
vt_va_NPC_mean_first, vt_va_NPC_95_first, vt_va_NPC_05_first = get_plot_data(
    vt_va_Cxy_NPC, period="first"
)

vt_va_NAL_mean_last, vt_va_NAL_95_last, vt_va_NAL_05_last = get_plot_data(
    vt_va_Cxy_NAL, period="last"
)
vt_va_NPC_mean_last, vt_va_NPC_95_last, vt_va_NPC_05_last = get_plot_data(
    vt_va_Cxy_NPC, period="last"
)
...
# Plot vt_va_Cxy
axes[0] = plot_coherence(
    vt_va_Cxy["frequency"], vt_va_mean, vt_va_05, vt_va_95, axes[0], label="Global Mean"
)

# Plot vt_va_NAL and vt_va_NPC on the same axis
plot_coherence(
    vt_va_Cxy_NAL["frequency"],
    vt_va_NAL_mean,
    vt_va_NAL_05,
    vt_va_NAL_95,
    axes[0],
    color_line="orange",
    color_shading="orange",
    label="NAL",
)
plot_coherence(
    vt_va_Cxy_NPC["frequency"],
    vt_va_NPC_mean,
    vt_va_NPC_05,
    vt_va_NPC_95,
    axes[0],
...
# Plot hus_std va NPC
plot_coherence(
    hus_vt_Cxy_NPC["frequency"], hus_vt_NPC_mean, hus_vt_NPC_05, hus_vt_NPC_95, axes[1]
)
axes[1].set_title("hus_std va NPC")

# Plot hus_std va NAL
plot_coherence(
    hus_vt_Cxy_NAL["frequency"], hus_vt_NAL_mean, hus_vt_NAL_05, hus_vt_NAL_95, axes[2]
)
...
axes[0] = plot_coherence(
    vt_va_Cxy["frequency"], vt_va_mean, vt_va_05, vt_va_95, axes[0]
)
axes[0].set_title("vt va")

# Plot hus_std va NPC and tas_std va NPC on the same axis
plot_coherence(
    tas_vt_Cxy_NPC["frequency"],
    tas_vt_NPC_mean,
    tas_vt_NPC_05,
    tas_vt_NPC_95,
    axes[1],
