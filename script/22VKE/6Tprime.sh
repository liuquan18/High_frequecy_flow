...
T_path=/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/ta_daily/r${member}i1p1f1/


if [ "$frequency" == "prime" ]; then
    Tp_path=/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/ta_prime_daily/r${member}i1p1f1/
else
...
T_prime(){
    ...
    Tpfile_name=${Tp_path}${Tfile_name//tas/tas_prime}
