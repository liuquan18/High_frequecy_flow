...
def WB_composite(period, ens):
    ...
    if NAO_pos.empty:
        ...
        NAO_pos_range = comp.find_lead_lag_30days(
            NAO_pos, base_plev=25000, cross_plev=1
        )
    ...
    if NAO_neg.empty:
        ...
        NAO_neg_range = comp.find_lead_lag_30days(
            NAO_neg, base_plev=25000, cross_plev=1
        )
...
# %%
first_pos_AWBs, first_neg_AWBs, first_pos_CWBs, first_neg_CWBs = WB_occurrence_period(
    "first10"
)

# %%
last_pos_AWBs, last_neg_AWBs, last_pos_CWBs, last_neg_CWBs = WB_occurrence_period(
    "last10"
)
...
axes[1].legend()
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/wave_break/pos_AWB_neg_CWB_occurrence.png",
    dpi=300,
)
# %%
# pos_CWB, neg_AWB
...
axes[1].legend()
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/wave_break/pos_CWB_neg_AWB_occurrence.png",
    dpi=300,
)
# %%
