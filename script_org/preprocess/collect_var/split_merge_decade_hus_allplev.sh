...
to_path=/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6_allplev/${var}_trop_daily/r${member}i1p1f1/
tmp_path=/scratch/m/m300883/${var}_plev/r${member}i1p1f1/
