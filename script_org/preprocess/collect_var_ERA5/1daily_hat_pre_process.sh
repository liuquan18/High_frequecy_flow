...
if [ -z "$3" ]; then
    levels="20000,22500,25000,30000,35000,40000,45000,50000,55000,60000,65000,70000,75000,77500,80000,82500,85000,87500,90000,92500,95000,97500,100000"
else
    levels="$3"
fi
...
#         sleep 30
#     done
#     srun --ntasks=1 --cpus-per-task=$SLURM_CPUS_PER_TASK pre_process "$file" &
# done
