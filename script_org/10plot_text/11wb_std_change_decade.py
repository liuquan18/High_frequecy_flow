...
#%%
awbs = xr.open_mfdataset("/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/wb_anticyclonic_fldmean/*.nc",
                        combine='by_coords')
                         
#%%
cwbs = xr.open_mfdataset("/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/wb_cyclonic_fldmean/*.nc",
                        combine='by_coords')
#%%
