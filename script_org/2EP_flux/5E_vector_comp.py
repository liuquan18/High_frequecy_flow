...
def cal_E_div(decade, phase, eddy='transient', **kwargs):
    ...
    if eddy == 'transient':
        M2 = read_comp_var('M2_prime', phase, decade, time_window = (-10, 5), name = 'M2', model_dir = 'MPI_GE_CMIP6_allplev')
        upvp = read_comp_var('upvp', phase, decade, time_window = (-10, 5), name = 'upvp', model_dir = 'MPI_GE_CMIP6_allplev')
    else:
        M2 = read_comp_var('M2_steady', phase, decade, time_window = (-10, 5), name = 'M2', model_dir = 'MPI_GE_CMIP6_allplev')
