...
to_path = '/work/mh0033/m300883/High_frequecy_flow/data/ERA5_allplev/equiv_theta_daily/'

if rank == 0:
    if not os.path.exists(to_path):
        os.makedirs(to_path)
    logging.info("This node is processing equivalent potential temperature")
