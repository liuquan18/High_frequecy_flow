...
def process_data(decade, var, integrate=False, **kwargs):
    ...
    if suffix == '_ano':
        save_dir_pos=f'/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/0stat_results/{var}_NAO_pos_{time_window}_mean_{decade}.nc'
        save_dir_neg=f'/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/0stat_results/{var}_NAO_neg_{time_window}_mean_{decade}.nc'
    elif suffix == '':
        save_dir_pos=f'/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/0stat_results_without_ano/{var}_NAO_pos_{time_window}_mean_{decade}.nc'
        save_dir_neg=f'/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/0stat_results_without_ano/{var}_NAO_neg_{time_window}_mean_{decade}.nc'
