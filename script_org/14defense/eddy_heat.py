...
# )
# %%
# New plot: Only the third row (line plots of eddy_heat_d2y2)
fig2, axes2 = plt.subplots(1, 3, figsize=(10, 4), sharey=True)
...
axes2[1].set_title("Quasi-stationary")
axes2[1].set_ylabel("")
...
#     frameon=False,
# )
# axes2[1].add_artist(decade_legend)
# axes2[1].add_artist(phase_legend)

# # save
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/0defense/eddy_heat_dy_d2y2_lines_only.png",
    dpi=500,
    bbox_inches="tight",
    transparent=True,
    metadata={"Creator": __file__},
