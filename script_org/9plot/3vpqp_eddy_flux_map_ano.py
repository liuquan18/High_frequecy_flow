...
# %%
vsets_clim_first = read_climatology("Fdiv_p_steady", "1850", name="Fdiv_p_steady", model_dir = 'MPI_GE_CMIP6_allplev')
vsets_clim_last = read_climatology("Fdiv_p_steady", "2090", name="Fdiv_p_steady", model_dir = 'MPI_GE_CMIP6_allplev')
...
vpetp_levels_steady = np.arange(-4, 4.1, 0.5)
# %%
...
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/0eddy_flux/eddy_heat_flux_ano.pdf",
    bbox_inches="tight",
    dpi=300,
    transparent=True,
)
