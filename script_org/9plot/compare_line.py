...
pos_new = pos_new.sel(plev = 85000)
neg_new = neg_new.sel(plev = 85000)

#%%
pos_old_df = to_dataframe(pos_old, 'div', 'pos', 1850)
neg_old_df = to_dataframe(neg_old, 'div', 'neg', 1850)
pos_new_df = to_dataframe(pos_new, 'div', 'pos', 2090)
neg_new_df = to_dataframe(neg_new, 'div', 'neg', 2090)
#%%
fig, ax = plt.subplots(figsize=(10, 6))
sns.lineplot(
    data = pos_new_df,
