...
# %%
# erase white line
Tdivphi_pos_first = erase_white_line(Tdivphi_pos_first)
Tdiv_p_pos_first = erase_white_line(Tdiv_p_pos_first)
Tdivphi_neg_first = erase_white_line(Tdivphi_neg_first)
Tdiv_p_neg_first = erase_white_line(Tdiv_p_neg_first)
Tdivphi_pos_last = erase_white_line(Tdivphi_pos_last)
Tdiv_p_pos_last = erase_white_line(Tdiv_p_pos_last)
Tdivphi_neg_last = erase_white_line(Tdivphi_neg_last)
Tdiv_p_neg_last = erase_white_line(Tdiv_p_neg_last)
#%%
...
# %%
# smooth the data
Tdivphi_pos_first = map_smooth(Tdivphi_pos_first, 5, 5)
Tdiv_p_pos_first = map_smooth(Tdiv_p_pos_first, 5, 5)
Tdivphi_neg_first = map_smooth(Tdivphi_neg_first, 5, 5)
Tdiv_p_neg_first = map_smooth(Tdiv_p_neg_first, 5, 5)
Tdivphi_pos_last = map_smooth(Tdivphi_pos_last, 5, 5)
Tdiv_p_pos_last = map_smooth(Tdiv_p_pos_last, 5, 5)
Tdivphi_neg_last = map_smooth(Tdivphi_neg_last, 5, 5)
Tdiv_p_neg_last = map_smooth(Tdiv_p_neg_last, 5, 5)
#%%
...
#%%
# erase white line
TEx_pos_first = erase_white_line(TEx_pos_first)
TEx_neg_first = erase_white_line(TEx_neg_first)
TEx_pos_last = erase_white_line(TEx_pos_last)
TEx_neg_last = erase_white_line(TEx_neg_last)
...
#%%
# smooth the data
TEx_pos_first = map_smooth(TEx_pos_first, 5, 5)
TEx_neg_first = map_smooth(TEx_neg_first, 5, 5)
TEx_pos_last = map_smooth(TEx_pos_last, 5, 5)
TEx_neg_last = map_smooth(TEx_neg_last, 5, 5)
...
# %%
# erase white line
Sdivphi_pos_first = erase_white_line(Sdivphi_pos_first)
Sdiv_p_pos_first = erase_white_line(Sdiv_p_pos_first)
Sdivphi_neg_first = erase_white_line(Sdivphi_neg_first)
Sdiv_p_neg_first = erase_white_line(Sdiv_p_neg_first)
Sdivphi_pos_last = erase_white_line(Sdivphi_pos_last)
Sdiv_p_pos_last = erase_white_line(Sdiv_p_pos_last)
Sdivphi_neg_last = erase_white_line(Sdivphi_neg_last)
Sdiv_p_neg_last = erase_white_line(Sdiv_p_neg_last)
# %%
...
# %%
# smooth the data
Sdivphi_pos_first = map_smooth(Sdivphi_pos_first, 5, 5)
Sdiv_p_pos_first = map_smooth(Sdiv_p_pos_first, 5, 5)
Sdivphi_neg_first = map_smooth(Sdivphi_neg_first, 5, 5)
Sdiv_p_neg_first = map_smooth(Sdiv_p_neg_first, 5, 5)
Sdivphi_pos_last = map_smooth(Sdivphi_pos_last, 5, 5)
Sdiv_p_pos_last = map_smooth(Sdiv_p_pos_last, 5, 5)
Sdivphi_neg_last = map_smooth(Sdivphi_neg_last, 5, 5)
Sdiv_p_neg_last = map_smooth(Sdiv_p_neg_last, 5, 5)
#%%
...
#%%
# erase white line
SEx_pos_first = erase_white_line(SEx_pos_first)
SEx_neg_first = erase_white_line(SEx_neg_first)
SEx_pos_last = erase_white_line(SEx_pos_last)
SEx_neg_last = erase_white_line(SEx_neg_last)
...
#%%
# smooth the data
SEx_pos_first = map_smooth(SEx_pos_first, 5, 5)
SEx_neg_first = map_smooth(SEx_neg_first, 5, 5)
SEx_pos_last = map_smooth(SEx_pos_last, 5, 5)
SEx_neg_last = map_smooth(SEx_neg_last, 5, 5)
...
Txy_pos_first = (TEx_pos_first + Tdivphi_pos_first).sel(plev=25000)
Txy_neg_first = (TEx_neg_first + Tdivphi_neg_first).sel(plev=25000)
Txy_pos_last = (TEx_pos_last + Tdivphi_pos_last).sel(plev=25000)
Txy_neg_last = (TEx_neg_last + Tdivphi_neg_last).sel(plev=25000)
# steady eddies
Sxy_pos_first = (SEx_pos_first + Sdivphi_pos_first).sel(plev=25000)
Sxy_neg_first = (SEx_neg_first + Sdivphi_neg_first).sel(plev=25000)
Sxy_pos_last = (SEx_pos_last + Sdivphi_pos_last).sel(plev=25000)
Sxy_neg_last = (SEx_neg_last + Sdivphi_neg_last).sel(plev=25000)
#%%
...
sum_div_p_pos_first = (Tdiv_p_pos_first + Sdiv_p_pos_first).sel(plev=85000)
trans_div_p_pos_first = Tdiv_p_pos_first.sel(plev=85000)
steady_div_p_pos_first = Sdiv_p_pos_first.sel(plev=85000)

sum_div_p_neg_first = (Tdiv_p_neg_first + Sdiv_p_neg_first).sel(plev=85000)
trans_div_p_neg_first = Tdiv_p_neg_first.sel(plev=85000)
steady_div_p_neg_first = Sdiv_p_neg_first.sel(plev=85000)

# last
sum_div_p_pos_last = (Tdiv_p_pos_last + Sdiv_p_pos_last).sel(plev=85000)
trans_div_p_pos_last = Tdiv_p_pos_last.sel(plev=85000)
steady_div_p_pos_last = Sdiv_p_pos_last.sel(plev=85000)

sum_div_p_neg_last = (Tdiv_p_neg_last + Sdiv_p_neg_last).sel(plev=85000)
trans_div_neg_last = Tdiv_p_neg_last.sel(plev=85000)
steady_div_p_neg_last = Sdiv_p_neg_last.sel(plev=85000)
#%%
# read vapor flux
...
# save
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/0eddy_flux/transient_div_p_map_withoutano.pdf",
    bbox_inches="tight",
    dpi=300,
)
# %%
...
sum_arrows = axes[0, 0].quiver(
    qsumflux_pos_last.lon.values[::5],
    qsumflux_pos_last.lat.values[::5],
    qsumflux_pos_last.u.values[::5, ::5],
    qsumflux_pos_last.v.values[::5, ::5],
    scale=qscale_sum,
    transform=ccrs.PlateCarree(),
    color="green",
    width=0.005,
...
# quiver for vapor flux anomaly (last 10 years)
trans_arrows = axes[0, 1].quiver(
    qpflux_pos_last.lon.values[::5],
    qpflux_pos_last.lat.values[::5],
    qpflux_pos_last.u.values[::5, ::5],
    qpflux_pos_last.v.values[::5, ::5],
    scale=qscale,
    transform=ccrs.PlateCarree(),
    color="green",
    width=0.005,
...
# quiver for vapor flux anomaly (last 10 years)
steady_arrows = axes[0, 2].quiver(
    qsflux_pos_last.lon.values[::5],
    qsflux_pos_last.lat.values[::5],
    qsflux_pos_last.u.values[::5, ::5],
    qsflux_pos_last.v.values[::5, ::5],
    scale=qscale_steady,
    transform=ccrs.PlateCarree(),
    color="green",
    width=0.005,
...
# quiver for vapor flux anomaly (last 10 years)
sum_arrows_neg = axes[1, 0].quiver(
    qsumflux_neg_last.lon.values[::5],
    qsumflux_neg_last.lat.values[::5],
    qsumflux_neg_last.u.values[::5, ::5],
    qsumflux_neg_last.v.values[::5, ::5],
    scale=qscale_sum,
    transform=ccrs.PlateCarree(),
    color="green",
    width=0.005,
...
# quiver for vapor flux anomaly (last 10 years)
trans_arrows_neg = axes[1, 1].quiver(
    qpflux_neg_last.lon.values[::5],
    qpflux_neg_last.lat.values[::5],
    qpflux_neg_last.u.values[::5, ::5],
    qpflux_neg_last.v.values[::5, ::5],
    scale=qscale,
    transform=ccrs.PlateCarree(),
    color="green",
    width=0.005,
...
steady_arrows_neg = axes[1, 2].quiver(
    qsflux_neg_last.lon.values[::5],
    qsflux_neg_last.lat.values[::5],
    qsflux_neg_last.u.values[::5, ::5],
    qsflux_neg_last.v.values[::5, ::5],
    scale=qscale_steady,
    transform=ccrs.PlateCarree(),
    color="green",
    width=0.005,
...
#%%
# E_x
sum_Ex_pos_first = (TEx_pos_first + SEx_pos_first).sel(plev=25000)
sum_Ex_neg_first = (TEx_neg_first + SEx_neg_first).sel(plev=25000)

sum_Ex_pos_last = (TEx_pos_last + SEx_pos_last).sel(plev=25000)
sum_Ex_neg_last = (TEx_neg_last + SEx_neg_last).sel(plev=25000)

trans_Ex_pos_first = TEx_pos_first.sel(plev=25000)
trans_Ex_neg_first = TEx_neg_first.sel(plev=25000)

trans_Ex_pos_last = TEx_pos_last.sel(plev=25000)
trans_Ex_neg_last = TEx_neg_last.sel(plev=25000)

steady_Ex_pos_first = SEx_pos_first.sel(plev=25000)
steady_Ex_neg_first = SEx_neg_first.sel(plev=25000)

steady_Ex_pos_last = SEx_pos_last.sel(plev=25000)
steady_Ex_neg_last = SEx_neg_last.sel(plev=25000)
#%%
#E_y
sum_Ey_pos_first = (Tdivphi_pos_first + Sdivphi_pos_first).sel(plev=25000)
sum_Ey_neg_first = (Tdivphi_neg_first + Sdivphi_neg_first).sel(plev=25000)

sum_Ey_pos_last = (Tdivphi_pos_last + Sdivphi_pos_last).sel(plev=25000)
sum_Ey_neg_last = (Tdivphi_neg_last + Sdivphi_neg_last).sel(plev=25000)

trans_Ey_pos_first = Tdivphi_pos_first.sel(plev=25000)
trans_Ey_neg_first  = Tdivphi_neg_first.sel(plev=25000)

trans_Ey_pos_last = Tdivphi_pos_last.sel(plev=25000)
trans_Ey_neg_last = Tdivphi_neg_last.sel(plev=25000)

steady_Ey_pos_first = Sdivphi_pos_first.sel(plev=25000)
steady_Ey_neg_first = Sdivphi_neg_first.sel(plev=25000)

steady_Ey_pos_last = Sdivphi_pos_last.sel(plev=25000)
steady_Ey_neg_last = Sdivphi_neg_last.sel(plev=25000)
...
#%%
# to anomaly
ua_pos_first = ua_pos_first - ua_clima_first
ua_neg_first = ua_neg_first - ua_clima_first
ua_pos_last = ua_pos_last - ua_clima_last
ua_neg_last = ua_neg_last - ua_clima_last

va_pos_first = va_pos_first - va_clima_first
va_neg_first = va_neg_first - va_clima_first
va_pos_last = va_pos_last - va_clima_last
va_neg_last = va_neg_last - va_clima_last
...
# save
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/0eddy_flux/transient_Ey_map_withoutanopdf",
    bbox_inches="tight",
    dpi=300,
)
...
# save
plt.savefig(
    "/work/mh0033/m300883/High_frequecy_flow/docs/plots/0eddy_flux/transient_Ex_map_withoutanopdf",
    bbox_inches="tight",
    dpi=300,
)
#%%
...
sum_color_first = (Tdiv_p_clima_first.sel(plev=85000) + Sdiv_p_clima_first.sel(plev=85000)).plot.contourf(
    ax=axes[0, 0],
...
# transient
prime_color_first = Tdiv_p_clima_first.sel(plev=85000).plot.contourf(
    ax=axes[0, 1],
    levels=levels_vt_prime,
    cmap="RdBu_r",
    add_colorbar=False,
...
# steady
steady_color_first = Sdiv_p_clima_first.sel(plev=85000).plot.contourf(
    ax=axes[0, 2],
    levels=levels_vt_steady,
    cmap="RdBu_r",
    add_colorbar=False,
...
# last 10 years
# sum (transient + steady)
sum_color_last = (Tdiv_p_clima_last.sel(plev=85000) + Sdiv_p_clima_last.sel(plev=85000)).plot.contourf(
    ax=axes[1, 0],
    levels=levels_vt,
    cmap="RdBu_r",
    add_colorbar=False,
...
# transient
prime_color_last = Tdiv_p_clima_last.sel(plev=85000).plot.contourf(
    ax=axes[1, 1],
    levels=levels_vt_prime,
    cmap="RdBu_r",
    add_colorbar=False,
...
# steady
steady_color_last = Sdiv_p_clima_last.sel(plev=85000).plot.contourf(
    ax=axes[1, 2],
    levels=levels_vt_steady,
    cmap="RdBu_r",
    add_colorbar=False,
...
fig.colorbar(
    ...
    cax=cax_sum,
    orientation="horizontal",
    label=r"$\frac{\partial}{\partial p} \left( f_0 \frac{\overline{v'\theta_e'}}{\overline{\theta}_p} \right)$ [m s$^{-1}$ day$^{-1}$] (sum)",
)
fig.colorbar(
    prime_color_first,
    cax=cax_prime,
    orientation="horizontal",
    label=r"$\frac{\partial}{\partial p} \left( f_0 \frac{\overline{v'\theta_e'}}{\overline{\theta}_p} \right)$ [m s$^{-1}$ day$^{-1}$] (transient)",
)
fig.colorbar(
    steady_color_first,
    cax=cax_steady,
    orientation="horizontal",
    label=r"$\frac{\partial}{\partial p} \left( f_0 \frac{\overline{v'\theta_e'}}{\overline{\theta}_p} \right)$ [m s$^{-1}$ day$^{-1}$] (steady)",
)
