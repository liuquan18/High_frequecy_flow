...
# %%
def read_theta_2pvu(decade, phase, time_window = (-5, 5)):
    ...
    return ds
#%%
def read_wb(decade, wb_type, phase, time_window = (-5, 5)):
...
CWB_neg_first = read_wb(1850, "CWB", "neg")

AWB_pos_last = read_wb(2090, "AWB", "pos")
CWB_neg_last = read_wb(2090, "CWB", "neg")
