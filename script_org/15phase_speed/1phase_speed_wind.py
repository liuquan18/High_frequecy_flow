...
# %%
# save path
output_path = f"/scratch/m/m300883/upvp_phase_speed_spectrum_daily/r{ens}i1p1f1/dec_{decade}/"
if rank == 0:
...
for year_idx, year in enumerate(my_years):
    ...
    # Save to NetCDF
    output_file = f"{output_path}phase_speed_upvp_cospectra_{plev/100:.0f}hPa_{decade}_{year}_r{ens}i1p1f1.nc"
