	...
	if eddy == 'transient':
		...
		if equiv_theta:
			...
			theta_ensmean_path=glob.glob(
				f"/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/equiv_theta_monthly_ensmean/equiv_theta_monmean_ensmean_{decade}*.nc"
			)[0]
			...
			theta_ensmean_path=glob.glob(
				f"/work/mh0033/m300883/High_frequecy_flow/data/MPI_GE_CMIP6/theta_monthly_ensmean/theta_monmean_ensmean_{decade}*.nc"
			)[0]
